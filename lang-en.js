...
(function(){
  ...
  const DICT={
    ...
    '儀表板':'Dashboard',
    '客訴管理':'Complaints',
    '下貨櫃發現':'Found at Unloading',
    '客戶回報':'Customer Reported',
    '處理中':'In Progress',
    '等待折讓單':'Awaiting Credit Note',
    '已結案':'Resolved',
    '新增客訴':'New Complaint',
    '客訴編號':'Complaint No.',
    '來源':'Source',
    '發現日期':'Date Found',
    '問題產品':'Defective Product',
    '異常數量':'Defect Qty',
    '異常描述':'Defect Description',
    '折讓單編號':'Credit Note No.',
    '取得後填入':'Fill in when received',
    '處理結果':'Resolution',
    '關聯船運':'Linked Shipment',
    '關聯採購單':'Linked PO',
    '建立客訴':'Create Complaint',
    '客訴已建立':'Complaint created',
    '客訴已更新':'Complaint updated',
    '請選擇來源':'Please select source',
    '請填寫異常描述':'Please fill in defect description',
    '工作追蹤':'Tasks',
    '訂單管理':'Orders',
    '船運管理':'Shipments',
    ...
    '庫存低於安全水位':'Stock below safety level',
    '庫存水位':'Stock Level',
    '庫存水位正常 ✓':'Stock levels normal ✓',
    '進行中詢價':'Active Inquiries',
    '進行中報價':'Active Quotes',
    '本月訂單':'Orders This Month',
    '待處理工作':'Pending Tasks',
    '待審批採購單':'POs Pending Approval',
    '建立採購':'Create Purchase',
    '客戶訂單量':'Customer Orders',
    '訂單筆數':'Orders',
    '總數量（米）':'Total Qty (m)',
    '此期間無訂單記錄':'No orders in this period',
    '本月':'This Month',
    '上月':'Last Month',
    '近3個月':'Last 3 Months',
    '近6個月':'Last 6 Months',
    ...
    '安全庫存水位 ':'Safety Stock Level',
    '目前庫存':'Current Stock',
    '安全水位':'Safety Level',
    '調整數量':'Adjustment',
    '庫存已更新':'Stock updated',
    '庫存':'Inventory',
    '沒有填入任何調整量':'No adjustments entered',
    '未設每卷米數，庫存未自動更新':'No meters/roll set — stock not updated',
    '注意：以下產品未設每卷米數，庫存未自動更新：':'Warning: missing meters/roll for:',
    '卷）':'roll)',
    '目前庫存（卷）':'Stock (rolls)',
    '安全庫存水位（卷）':'Safety Stock (rolls)',
    '調整（卷）':'Adjust (rolls)',
    '報關中':'Customs Clearance',
    '✓ 確認入庫':'✓ Confirm Receipt',
    '確認入庫 — 填寫實收數量':'Confirm Receipt — Enter received quantities',
    '儲存入庫紀錄 → 完成':'Save Receipt → Complete',
    '此次實收':'Received this time',
    '訂單量':'Ordered',
    '前次已到':'Prev. received',
    ...
    '→ 報關中':'→ Customs',
    '→ 確認完成':'→ Complete',
    '移除關聯失敗：':'Remove link failed: ',
    '移除採購單失敗：':'Remove PO failed: ',
    '移除關聯訂單失敗：':'Remove order link failed: ',
    '載入船運失敗：':'Load shipments failed: ',
    '載入船運關聯失敗：':'Load shipment links failed: ',
    '更新船運狀態失敗：':'Update shipment status failed: ',
    '儲存船運失敗：':'Save shipment failed: ',
    // 採購單
    '採購單已儲存':'PO saved',
    '採購單已取消':'PO cancelled',
    '採購單已審批通過':'PO approved',
    '採購單已建立':'PO created',
    '採購單已拒絕':'PO rejected',
    '採購單已掛入船運批次':'PO linked to shipment',
    '採購單已移出船運批次':'PO unlinked from shipment',
    '採購車為空':'Cart is empty',
    '加入採購單失敗：':'Add to PO failed: ',
    '載入採購單失敗：':'Load PO failed: ',
    '載入採購單品項失敗：':'Load PO items failed: ',
    '載入採購單關聯訂單失敗：':'Load PO order links failed: ',
    '全部品項已到齊，採購單狀態更新為已到貨':'All items received — PO marked as received',
    '到貨已登記':'Receipt recorded',
    // 訂單
    '訂單已建立':'Order created',
    '訂單已更新':'Order updated',
    '訂單已刪除':'Order deleted',
    '訂單審批通過':'Order approved',
    '訂單審批已拒絕':'Order rejected',
    '建立訂單失敗：':'Create order failed: ',
    '品項建立失敗，訂單未建立：':'Item failed, order not created: ',
    // 樣品
    '樣品已新增':'Sample added',
    '樣品已刪除':'Sample deleted',
    '樣品資料已更新':'Sample updated',
    '索取記錄已新增':'Request recorded',
    '回饋已登記':'Feedback recorded',
    '寄出記錄已新增，庫存已扣除':'Sent — stock deducted',
    '已標記到貨，庫存已更新':'Marked received — stock updated',
    // 報價
    '報價已儲存':'Quote saved',
    '報價預設值已儲存':'Quote defaults saved',
    '已儲存修改前快照，請更新報價內容後重新送出':'Snapshot saved — update quote and resubmit',
    '已建立新版本':'New version created',
    '建立新版本失敗：':'Create new version failed: ',
    '快照儲存失敗：':'Snapshot save failed: ',
    '送去報價失敗：':'Send to quote failed: ',
    '已送去報價':'Sent to quote',
    // 客戶/供應商
    '客戶已新增':'Customer added',
    '客戶已更新':'Customer updated',
    '客戶聯絡人已新增':'Customer contact added',
    '客戶名稱同步失敗：':'Customer name sync failed: ',
    '供應商資料已儲存':'Supplier saved',
    '供應商聯絡人已新增':'Supplier contact added',
    '供應商名稱同步失敗：':'Supplier name sync failed: ',
    '儲存供應商失敗：':'Save supplier failed: ',
    '儲存客戶失敗：':'Save customer failed: ',
    // 品項
    '品項已儲存':'Item saved',
    '品項已刪除':'Item deleted',
    '品項已加入':'Item added',
    '品項儲存失敗：':'Save item failed: ',
    '品項寫入失敗：':'Write item failed: ',
    '品項建立失敗：':'Create item failed: ',
    '品項新增失敗：':'Add item failed: ',
    '品項複製失敗：':'Copy item failed: ',
    '新增品項失敗：':'Add item failed: ',
    '更新品項失敗：':'Update item failed: ',
    // 產品
    '產品已新增':'Product added',
    '產品已更新':'Product updated',
    '產品目錄成本已更新':'Catalog cost updated',
    '已加入產品目錄':'Added to catalog',
    // 詢價
    '詢價單已建立':'Inquiry created',
    '建立詢價失敗：':'Create inquiry failed: ',
    // 分配/關聯
    '分配已加入暫存':'Allocation queued',
    '分配已新增':'Allocation added',
    '新增分配失敗：':'Add allocation failed: ',
    '缺少分配目標':'Missing allocation target',
    '關聯客戶訂單已新增':'Order link added',
    '關聯客戶訂單已移除':'Order link removed',
    '新增關聯訂單失敗：':'Add order link failed: ',
    '移除關聯訂單失敗：':'Remove order link failed: ',
    // 通用失敗
    '儲存失敗：':'Save failed: ',
    '更新失敗：':'Update failed: ',
    ...
    '已複製，可貼到 Email 或 WhatsApp':'Copied — paste to Email or WhatsApp',
    '狀態已更新':'Status updated',
    '狀態更新失敗：':'Status update failed: ',
    // 驗證
    '請填寫取消原因':'Please enter cancellation reason',
    ...
    '請填寫成本價':'Please enter cost price',
    '請填寫有效數量':'Please enter valid quantity',
    '請填寫有效的分配數量':'Please enter valid allocation quantity',
    '請填寫有效的數量與單價':'Please enter valid quantity and unit price',
    '請填寫產品名稱':'Please enter product name',
    '請填寫產品需求':'Please fill in product requirements',
    '請填寫船運編號':'Please enter shipment number',
    '請輸入有效數量':'Please enter valid quantity',
    '請選擇供應商':'Please select supplier',
    '請選擇客戶':'Please select customer',
    '請選擇客戶訂單':'Please select customer order',
    '請先選擇供應商':'Please select a supplier first',
    '請先選擇要掛入的採購單':'Please select a PO to link',
    '請勾選至少一筆品項':'Please select at least one item',
    '請先新增至少 1 筆產品品項，再建立採購單':'Add at least 1 item before creating PO',
    '請先新增至少 1 筆產品品項，再建立訂單':'Add at least 1 item before creating order',
    '請先新增至少 1 筆產品品項，再標記生產中':'Add at least 1 item before marking in production',
    '此品項尚未綁定產品目錄，暫時無法精準分配訂單':'Item not linked to catalog — allocation may be imprecise',
    '同一張訂單與同一採購品項已存在，請直接調整原本那筆':'Duplicate order-item link — edit the existing one',
    '同一採購品項對同一訂單已存在，請直接調整原本那筆':'Duplicate item-order link — edit the existing one',
    '只有管理者可以調整系統設定':'Only admins can modify system settings',
    '密碼錯誤':'Incorrect password',
    // 雜項
    '口頭承諾':'Verbal commitment',
    '需修改':'Needs revision',
    '已建立':'Created',
    '統一客戶回顧週期':'Unified customer review cycle',
    '統一產品更新週期':'Unified product update cycle',
    '預設利潤':'Default margin',
    '預設清關手續費':'Default customs fee',
    '報價單':'Quotation',
    '採購單':'Purchase Order',
    ...
    '總計':'Total',
    '櫃號':'Container No.',
    '確定要刪除這筆客訴嗎？':'Delete this complaint?',
    '失敗：':'Failed: ',
    // 按鈕
    '+ 掛入':'+ Link',
    '+ 新增客訴':'+ New Complaint',
    '儲存調整':'Save Adjustments',
    '加入採購單':'Add to PO',
    '建立採購單':'Create PO',
    '建立訂單':'Create Order',
    '從產品目錄選':'Select from Catalog',
    '從訂單帶入':'Import from Order',
    '拒絕 ✗':'Reject ✗',
    '新增分配':'New Allocation',
    '確認取消':'Confirm Cancel',
    '直接新增報價單':'Create Quote Directly',
    // 標籤 / 狀態文字
    '推進狀態：':'Advance:',
    '⚠ ETA 已到':'⚠ ETA reached',
    '⚠ ETD 已到':'⚠ ETD reached',
    '✓ 目前無待追蹤項目':'✓ Nothing to follow up',
    '小計':'Subtotal',
    '寬幅(mm)':'Width (mm)',
    '安全水位（卷）':'Safety Level (rolls)',
    '產品目錄成本有差異':'Catalog cost discrepancy',
    '尚無客訴記錄':'No complaints on record',
    '尚無設定安全庫存水位的產品':'No products with safety stock configured',
    '在產品目錄編輯產品時填入「安全庫存水位」即可加入追蹤':'Set safety stock in product catalog to enable tracking',
    '低於此值儀表板警示':'Dashboard alert when below this',
    '全部來源':'All sources',
    '品項':'Items',
